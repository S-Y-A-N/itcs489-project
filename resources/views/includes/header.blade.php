    ...
    <div class="p-3 text-center border-bottom bg-primary-subtle">
      <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center gap-4">
          ...
          <!-- Logo -->
          <div>
            @include('includes.brand', ['font_size'=> 4, 'logo_size' => 30])
          </div>

          <!-- Search bar -->
          <div class="w-75">
            <div class="input-group">
              <span class="input-group-text bg-body border-end-0 border-secondary-subtle"><i class="bi bi-search"></i></span>
              <input type="text" class="form-control border-start-0 border-secondary-subtle">
              <button class="btn btn-outline-secondary bg-body border-start-0 border-secondary-subtle" type="button" id="button-addon2"><i class="bi bi-camera-fill" aria-hidden="true"></i></button>
    ...
    <div class="p-3 text-center border-bottom bg-body-tertiary">
      ...
      <div class="container-fluid">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-2">
          <!-- Shop by Categories -->
          <div class="categories-nav container-fluid align-items-center justify-content-between gap-3 position-relative m-0 p-0">

            <!-- 1- Categories button -->
            <div class="navbar-toggler border-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar" aria-label="Toggle navigation">
