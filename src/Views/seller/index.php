...
<head>
    ...
    <title>VendorPro Dashboard</title>
        ...
        <aside class="w-64 bg-white shadow-sm border-r border-indigo-200 flex flex-col">
            ...
            <nav class="flex-1 p-4 overflow-y-auto">
                <div class="mb-8">
                    ...
                    <ul class="space-y-1">
                        <li>
                            <a href="/itcs489-supplier/index.php" class="sidebar-item flex items-center px-4 py-3 text-sm font-medium rounded-lg bg-primary-50 text-primary">
                ...
                <div class="mt-auto border-t border-gray-200 pt-4">
                    ...
                    <ul class="space-y-1">
                        <li>
                            <a href="/itcs489-supplier/accoutSetting.php" class="sidebar-item flex items-center px-4 py-3 text-sm font-medium rounded-lg text-gray-600 hover:bg-gray-100">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    ...
                    <div class="bg-white rounded-xl shadow-card p-6 equal-height-container">
                        <div class="flex justify-between items-center mb-6">
                            ...
                            <a href="/orders.html" class="text-sm font-medium text-primary hover:text-secondary flex items-center">
