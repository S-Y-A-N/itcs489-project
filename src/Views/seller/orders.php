...
<head>
    ...
    <title>Orders Dashboard | VendorPro</title>
            ...
            <nav class="flex-1 p-4 overflow-y-auto">
                <div class="mb-8">
                    ...
                    <ul class="space-y-1">
                        ...
                        <li>
                            <a href="/itcs489-supplier/orders.php" class="sidebar-item flex items-center px-4 py-3 text-sm font-medium rounded-lg bg-primary-50 text-primary">
